<template>
  <div class="page-wrapper-privacy-policy">
    <Column class="content col-static-page">
      <h2>Privacy Policy</h2>
      <p>Your privacy is important to us. It is DevDB's policy to respect your privacy regarding any information we may collect from you across our website, <a href="https://devdb.io">https://devdb.io</a>, and other sites we own and operate.</p>
      ...
      <p>This privacy policy only covers DevDB's own collecting and handling of data. We only work with partners, affiliates and third-party providers whose privacy policies align with ours, however we cannot accept responsibility or liability for their respective privacy practices.</p>
      ...
      <p><strong>DevDB Data Controller</strong><br />
      Nikolay Ten<br />
      nrzhannoy[at]gmail.com</p>
      <p><strong>DevDB Data Protection Officer</strong><br />
      Nikolay Ten<br />
      nrzhannoy[at]gmail.com</p>
      <p>This policy is effective as of 21 December 2018.</p>
    </Column>
  </div>
</template>
